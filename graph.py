...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        Edge.__init__(self,src,dest) # inherting the constructor 
    ...
    def __str__(self):
        ...
        # return str(self.total_distance,self.outdoor_distance)
        # return  (self.src , self.dest)
        # pass  # TODO

#print(e)

class Digraph(Edge):   # inhert the function getsource 
    ...
    def add_edge(self, edge):
        ...
        if src not in self.nodes or dest not in self.edges :
        #if not (src in self.nodes and dest in self.edges):
...
# ================================================================
# Begin tests -- you do not need to modify anything below this lineck
# ================================================================
